...
- If you're unsure if a feature would make a good addition, you can always [create an issue](https://github.com/Coaktion/zendesk-clients-react/issues/new) first. Raising an issue before creating a pull request is recommended.
...
Before opening a new issue, first check that there is not already an [open issue or Pull Request](https://github.com/Coaktion/zendesk-clients-react/issues?utf8=%E2%9C%93&q=is%3Aopen) that addresses it.
...
1. Pick an appropriate template for the type of issue [from here](https://github.com/Coaktion/zendesk-clients-react/issues/choose)
